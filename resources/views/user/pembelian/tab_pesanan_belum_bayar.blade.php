@if($cek_purchases)
    @foreach($checkouts as $checkout)
        @foreach($purchases as $purchase)
                                        ...
                                        <div class="col-md-12 mb-2">
                                            ...
                                            @if($purchase->status_pembelian == "status1" || $purchase->status_pembelian == "status1_ambil")
                                                @if($count_proof_of_payment->count_proof_of_payment != 0)
                                                    ...
                                                    @else
                                                    <a href="#batalkan_pembelian_{{$purchase->purchase_id}}_tab" class="btn btn-outline-dark btn-rounded" data-toggle="modal" href="" style="float:right">
                                                        <span>BATALKAN</span>
                                                    </a>
                                                    @endif
                                                @endif
            ...
            <div class="modal fade" id="batalkan_pembelian_{{$purchase->purchase_id}}_tab" tabindex="-1" role="dialog" aria-hidden="true">
