    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if ($target_metode_pembelian == "ambil_ditempat") {
                ...
                $("#subdistrict_address").append(
                    '<option value="" disabled selected>Pilih Alamat Kecamatan</option>'
                );
                ...
                $("#total_harga_checkout").append(
                    $("<a>", {
                        text:
                            "Rp." +
                            format_rupiah(
                                parseInt($total_harga_checkout) +
                                    parseInt($ongkir) -
                                    parseInt($potongan_pembelian) -
                                    parseInt($potongan_ongkir)
                            ),
                    })
                );
            ...
            $("#jumlah_potongan_subtotal").append(
                $("<input>", {
            ...
            $("#jumlah_potongan_subtotal").append(
                $("<td>", { text: "Voucher Pembelian: " })
            );
            $("#jumlah_potongan_subtotal").append(
                $("<td>", {
                    text: "- Rp." + format_rupiah($potongan_pembelian),
                })
            );
...
$("#voucher_ongkos_kirim").change(function (data) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $ongkir_hasil_potong =
                parseInt($ongkir) - parseInt($potongan_ongkir);
            ...
            $("#total_potongan_ongkir").empty();
            $("#total_potongan_ongkir").append(
                $("<td>", { text: "Voucher Ongkos Kirim: " })
            );
            $("#total_potongan_ongkir").append(
                $("<td>", { text: "- Rp." + format_rupiah($potongan_ongkir) })
            );
...
$("#pesanan_warehouse").click(function (data) {
    console.log($(this).val());
    $.ajax({
        type: "GET",
        dataType: "json",
...
$("#street_address").change(function (data) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $("#courier").append(
                $("<option>", { value: "pos", text: "POS Indonesia" })
            );
                    ...
                    costs["costs"].forEach((cost, indexCC) => {
                        cost["cost"].forEach((price) => {
                            ...
                            $("#service").change(function () {
                                ...
                                $("#invoice_ongkir").empty();
                                $("#invoice_ongkir").append(
                                    $("<td>", { text: "Ongkos Kirim: " })
                                );
                                $("#invoice_ongkir").append(
                                    $("<td>", {
                                        text: "Rp." + format_rupiah(ongkir),
                                    })
                                );
